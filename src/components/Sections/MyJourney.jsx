  ...
  return (
    <section id="my-journey">
      <SectionBanner bannerTitle={sectionList}>
        ...
        <span className="absolute left-1/2 top-1/2 z-0 h-[90%] w-[2px] -translate-x-1/2 -translate-y-1/2 transform bg-mainAccent lg:h-[15px] lg:w-[90%] lg:max-w-[1700px]"></span>
